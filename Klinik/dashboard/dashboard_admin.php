...
<body>
  <nav>
    <div class="navbar">
      ...
      <ul class="nav-links">
        <li><a href="../home_admin/LihatAntrianPasien/Lihatantrian.php">Lihat Antrian Pasien</a></li> |
        <li><a href="../home_admin/LaporanPasien/index.php">Laporan Pasien</a></li> |
        <li><a href="../home_admin/TambahAkun/Signup.php">Tambah Akun</a></li> |
  ...
  <section class="home-content">
    <div class="texts"><br>
      ...
      <h3 class="text"><span>“Digitalize Your Health"</span></h3>
      <p> kami menghadirkan IT sebagai bagian tak terpisahkan dari pemeliharaan kesehatan yang aman, bermutu dan terjangkau melalui Website Yang Saya Buat, Memberikan pelayanan keperawatan pada pasien, baik untuk kesembuhan ataupun pemulihan status fisik dan mental.</p>
