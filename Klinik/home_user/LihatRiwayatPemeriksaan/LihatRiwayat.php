...
<head>
    ...
    <title>Lihat Riwayat Pemeriksaan</title>
...
<body>
    ...
    <div class="container mt-2">
        ...
        <div class="p-1 bg-primary text-white">
            <h3 align="center">Lihat Riwayat Pemeriksaan Pasien</h3>
        </div>

        <!-- Awal Card Table Data Pasien  -->
        <div class="card">
            <div class="card-header bg-primary text-white">
                Table Data Riwayat Pemeriksaan
            </div>
            <div class="card-body">
                <table class="table table-bordered table table-striped">
                    ...
                    <?php
                    $tampil = "SELECT * FROM data_pemeriksaan 
                    LEFT JOIN data_pasien ON data_pemeriksaan.id_pasien = data_pasien.id_pasien";
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <?= $data['namapenyakit_pemeriksaan'] ?>
                        </td>
                        <td>
                            <?= $data['keluhan_pemeriksaan'] ?>
                        </td>
                        <td>
                            <?= $data['bagiansakit_pemeriksaan'] ?>
                        </td>
                        <td>
                            <?= $data['fotorontgen_pemeriksaan'] ?>
                        </td>
                        <td>
